...
with col1:
    ...
    fig_countries_by_steps_top10.update_layout(title='<b>Top 10 Countries with the Highest Average Steps per Day</b>', yaxis=dict(autorange="reversed"))
...
with col2:
    ...
    fig_countries_by_steps_bot10.update_layout(title='<b>Top 10 Countries with the Lowest Average Steps per Day</b>', yaxis=dict(autorange="reversed"))
